...
if [ ! -f haproxy/pcre-8.33.tar.gz ]; then
    wget http://blob.cfblob.com/2bf0743b-c496-4022-837d-2bbeaa83f32d
    mv 2bf0743b-c496-4022-837d-2bbeaa83f32d haproxy/pcre-8.33.tar.gz
fi

if [ ! -f haproxy/haproxy-1.5-dev19.tar.gz ]; then
    wget http://blob.cfblob.com/4832cdff-951f-4e76-b7b9-d7b126ddef8d
    mv 4832cdff-951f-4e76-b7b9-d7b126ddef8d haproxy/haproxy-1.5-dev19.tar.gz
fi
